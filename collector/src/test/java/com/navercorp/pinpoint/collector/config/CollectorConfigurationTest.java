...
public class CollectorConfigurationTest {
    ...
    public void l4IpTest() throws Exception {
        ...
        properties.put("collector.l4.ip", "127.0.0.1 ,192.168.176.136, 192.168.0.1, 255.255.255.255");
        ...
        Assert.assertTrue(collectorConfiguration.getL4IpList().contains("192.168.176.136"));
